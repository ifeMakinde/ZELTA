...
export default function Bayse() {
  return (
    <div>
      <section className="w-full h-auto lg:h-45 bg-white mt-5 rounded-2xl p-5 lg:p-3 shadow-sm">
        ...
        <p className="text-gray-500 mt-4 lg:mt-2.5 lg:ml-17 text-sm sm:text-xs">
          The Bayse crowd was 14% more fearful than the data warranted. This is
